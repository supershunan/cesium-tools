...
var Kc = (function () {
    var e =
        ...
        o = new Uint8Array([
            ...
            12, 40, 16, 19, 54, 20, 9, 27, 255, 113, 17, 42, 67, 24, 23, 146, 148, 18, 14, 22, 45,
...
var Ma = (function () {
    var e =
        ...
        c = new Uint8Array([
            0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 3, 2, 0, 0, 5, 3, 1, 0, 1, 12, 1, 0,
    ...
    function j(a) {
        ...
        return (
            (d.object.onmessage = function (n) {
                var t = n.data;
                ((d.pending -= t.count),
                    d.requests[t.id][t.action](t.value),
                    delete d.requests[t.id]);
            }),
            d
        );
    }
        ...
        self.ready.then(function (n) {
            try {
                ...
                (y(n, n.exports[d.mode], t, d.count, d.size, d.source, n.exports[d.filter]),
                    self.postMessage({ id: d.id, count: d.count, action: 'resolve', value: t }, [
                        t.buffer,
                    ]));
            } catch (i) {
    ...
    return {
        ...
        simplifySloppy: function (a, d, n, t, i, l) {
            ...
            var k = a.BYTES_PER_ELEMENT == 4 ? a : new Uint32Array(a),
                p = s(
                    c.exports.meshopt_simplifySloppy,
                    k,
                    a.length,
                    d,
                    d.length / n,
...
ub.createMesh = async function (e) {
    ...
    for (let V = 0; V < T; V++) {
        ...
        let Ra;
        (w && (Ra = s.geodeticSurfaceNormal(sa, Je)),
            (ca = la.encode(ea, ca, sa, Ca, ma, Da, ua, Ra)));
...
function kc(e) {
    ...
    for (let U = 0; U < m; U++) {
        ...
        if (s < 0) {
            let h = O,
                a = j;
            ((O = (1 - Math.abs(a)) * aa.signNotZero(h)),
                (j = (1 - Math.abs(h)) * aa.signNotZero(a)));
        }
        let f = Pa;
        ((f.x = O),
            (f.y = j),
...
function Fc(e, o, c, g, m, b, r, x) {
    ...
    for (let s = 0; s < o; s++) {
        ...
        for (let l = 0; l < y; l++) {
            ...
            (A >= 0 && (B.clone(k, O[U]), u.clone(p, j[U]), U++),
                (d = l),
                (n = k),
                (t = p),
                (i = A));
